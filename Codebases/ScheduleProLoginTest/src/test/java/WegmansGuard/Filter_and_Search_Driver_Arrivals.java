...
public class Filter_and_Search_Driver_Arrivals {
    public static void main(String[] args) {
        // Todo : Setting up ExtentReport package to give us test results.
        ExtentReports extent = new ExtentReports();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
        String timestamp = sdf.format(new Date());
        String filename = "target/Reports/Filter_and_search_Driver_arrivals-" + timestamp + ".html";
...
//            Navigate to Live Trucks
            navigate_to_Driver_Arrivals(driver, extent);
    ...
    public static void navigate_to_Driver_Arrivals(WebDriver driver, ExtentReports extent){
        try{
            ...
            driver.findElement(By.xpath("//a[text()=\"Driver Arrivals\"]")).click();
            ...
            WebElement live_trucks_text_element = driver.findElement(By.xpath("//div[@class='fw-bold' and text()=\"Driver Arrivals\"]"));
...
//            Todo : Let's test out while selecting the Inbound Load option.
            ...
            if(no_data_message.isDisplayed()){
                ...
                test_counting_inbound_load.info("Test cannot be performed, due to unavailability of data in Inbound Load.");
            }
            else{
